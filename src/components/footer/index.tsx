...
export default function Footer() {
  return (
    <footer className="bg-white shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 antialiased">
      ...
      <div className="flex justify-center items-center space-x-1">
        <a
          ...
          className="inline-flex justify-center p-2 text-gray-500 rounded-lg cursor-pointer  hover:text-bl-hover hover:bg-gray-100 "
        >
          <svg
            className="w-4 h-4"
            aria-hidden="true"
